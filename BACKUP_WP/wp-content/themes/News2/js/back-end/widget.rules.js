...
function gk_widget_control_init_events(id, inner) {
    ...
    if (form.attr('data-state') !== 'initialized') {
        ...
        var form_inputs = {};
        var form_inputs_names = ['page', 'post', 'category', 'category_descendant', 'tag', 'template', 'taxonomy', 'taxonomy_term', 'posttype', 'author', 'product_cat', 'shop'];
        ...
        select.change(function () {
            ...
            if (value === 'homepage' || value === 'page404' || value === 'search' || value === 'archive' || value === 'shop') {
        ...
        form.find('.gk_widget_rules_pages div').click(function (event) {
            if (event.target.nodeName.toLowerCase() === 'strong') {
                ...
                if (text === 'All pages') {
                    ...
                    text = 'template:';
                } else if (text === 'All product categories') {
                    text = 'product_cat:';
                }
                //
    ...
    if (output.length > 0) {
        ...
        for (var i = 0; i < pages.length; i++) {
            if (pages[i] !== '') {
                pages_exist = true;
                var type = 'homepage';
                var types = ['page:', 'post:', 'category:', 'category_descendant:', 'tag:', 'archive', 'author:', 'template:', 'taxonomy:', 'posttype:', 'page404', 'search', 'product_cat:', 'shop'];
                ...
                } else if (out === 'product_cat:') {
                    out = 'All product categories';
                }
