...
(function() {
	...
	jQuery(window).load(function() {
		if(jQuery('#gallery')) {
			...
			if (jQuery('#gallery').find('.gk-is-btn-prev')) {	
             jQuery('#gallery').find('.gk-is-btn-prev').click(function(e) {
					e.preventDefault();
					gkGalleryAnimationState = 'stop'; 
			...
			if (jQuery('#gallery').find('.gk-is-btn-next')) {	
             jQuery('#gallery').find('.gk-is-btn-next').click(function(e) {
					e.preventDefault();
					gkGalleryAnimationState = 'stop'; 
					gkGalleryAutoanimation('next', null);			
				}); 
