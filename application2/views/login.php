...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link href="https://cdn.keyzie.org/boots/plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css" />
...
<br>
              	<li><a href="<?php echo base_url(); ?>buku_manual_web.pdf" target="_blank">KLIK UNTUK DOWNLOAD BUKU MANUAL</a></li>
                    <li><a href="https://drive.google.com/file/d/0B9KfcQXn6_lrZ1kxVld5UlVBZTA/view?usp=sharing" target="_blank">KLIK UNTUK DOWNLOAD VIDEO PANDUAN</a></li>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    <!-- iCheck -->
    <script src="https://cdn.keyzie.org/boots/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
    <script>
      $(function () {
        $('input').iCheck({
